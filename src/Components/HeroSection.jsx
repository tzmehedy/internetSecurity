  ...
  return (
    <div className="flex flex-col md:flex-row md:space-x-5">
      ...
      <div className="md:w-1/2 text-white space-y-10 flex flex-col justify-center">
        ...
        <div>
          <button className="btn bg-linear-to-r from-red-800 to-red-600 text-white font-bold text-lg border-none shadow-none rounded-3xl hover:bg-linear-to-r hover:from-red-600 hover:to-red-800">
